...
public class EWalletApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("'Full' for printing a full report.");
		System.out.println("'Expense' for printing an expense report.");
		System.out.println("'ExpenseType' for printing an expense report by type.");
		System.out.println("'Income' for printing an income report.");
		System.out.println("'IncomeType' for printing an income report by type.");
		...
		while(true) {
			...
			else if (menuChoice.contentEquals("Full")) {
				calc.PrintFullreport();
			}
			else if (menuChoice.contentEquals("Expense")) {
				calc.PrintExpensereport();
			}
			else if (menuChoice.contentEquals("ExpenseType")) {
				calc.PrintExpensebyType();
			}
			else if (menuChoice.contentEquals("Income")) {
				calc.PrintIncomereport();
			}
			else if (menuChoice.contentEquals("IncomeType")) {
